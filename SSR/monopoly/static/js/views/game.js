...
class GameView {
    ...
    initComponents() {
        ...
        this.$chatMessageToSend.addEventListener("keydown", e => {
            ...
            //     if (event.code === '13') this.sendMessage();
            // }
    ...
    initWebSocket() {
        this.socket = new WebSocket(`ws://${window.location.host}/ws/game/${this.hostName}/`);
    ...
    async showModal(playerIndex, title, subTitle, message, buttons, displayTime) {
        return new Promise(resolve => {
            if (playerIndex === null) {
                ...
                this.$modalAvatar.src = `/static/img/player_${playerIndex}.png`;
    ...
    * */
    addChatMessage(playerIndex, message) {
        ...
        messageElement.innerHTML = `
            <img class="chat-message-avatar" src="/static/img/player_${playerIndex}.png">
...
GameView.DEFAULT_AVATAR = "/static/img/favicon.png";
